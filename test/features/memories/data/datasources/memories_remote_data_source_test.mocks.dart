...
import 'package:griot_app/core/services/thumbnail_services.dart' as _i6;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockThumbnailService extends _i1.Mock implements _i6.ThumbnailService {
  MockThumbnailService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i7.Uint8List?> generateThumbnail({required String? videoUrl}) =>
      (super.noSuchMethod(
        Invocation.method(
          #generateThumbnail,
          [],
